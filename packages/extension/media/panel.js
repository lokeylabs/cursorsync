...
(function () {
  ...
  const ICON = {
    ...
    inspect:
      '<svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"><path d="M3 7a2 2 0 0 1 2-2h3.6a2 2 0 0 1 1.4.6L11.4 7H17a2 2 0 0 1 2 2v2.5"/><path d="M3 7v11a2 2 0 0 0 2 2h6.2"/><circle cx="17" cy="17" r="3.2"/><path d="m21.5 21.5-2-2"/></svg>',
  };
